        ...
        submitOrder() {
            ...
            this.$http.post(order_url, this.form).then(data => {
                ...
                if (response.code == 200) {
                    ...
                    this.errorMessage = 'Проверьте правильность введенных полей ' +
                                        'и заполните обязательные поля!';
                } else {
                    this.errorMessage = 'Возникли непредвиденные неполадке при о' +
                                        'тправке письма. Приносим извинения за ' +
                                        'неудобства, пожалуйста, свяжитесь с нами ' +
                                        'напрямую.';
                }
            }).catch(error => {
